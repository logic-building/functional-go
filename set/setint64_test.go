...
func TestSetInt64Join(t *testing.T) {
	list := []int64{10, 20, 30, 20}
	mySet1 := NewSetInt64(list)

	list = []int64{30, 40, 50}
	mySet2 := NewSetInt64(list)
...
func TestSetInt64Superset(t *testing.T) {
	mySet1 := NewSetInt64([]int64{10, 20, 30, 20})
	mySet2 := NewSetInt64([]int64{10, 20})
	...
	mySet1 = NewSetInt64([]int64{10, 20, 30, 20})
	mySet2 = NewSetInt64([]int64{10, 20, 30, 20})

	if !mySet2.Superset(mySet1) {
		t.Errorf("TestSetInt64Subset failed. Expected=true, Actual=false")
	}

	mySet1 = NewSetInt64([]int64{10, 20, 30, 20, 40})
	mySet2 = NewSetInt64([]int64{10, 20, 30, 20})
