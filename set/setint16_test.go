...
func TestSetInt16Join(t *testing.T) {
	list := []int16{10, 20, 30, 20}
	mySet1 := NewSetInt16(list)

	list = []int16{30, 40, 50}
	mySet2 := NewSetInt16(list)
...
func TestSetInt16Superset(t *testing.T) {
	mySet1 := NewSetInt16([]int16{10, 20, 30, 20})
	mySet2 := NewSetInt16([]int16{10, 20})
	...
	mySet1 = NewSetInt16([]int16{10, 20, 30, 20})
	mySet2 = NewSetInt16([]int16{10, 20, 30, 20})

	if !mySet2.Superset(mySet1) {
		t.Errorf("TestSetInt16Subset failed. Expected=true, Actual=false")
	}

	mySet1 = NewSetInt16([]int16{10, 20, 30, 20, 40})
	mySet2 = NewSetInt16([]int16{10, 20, 30, 20})
