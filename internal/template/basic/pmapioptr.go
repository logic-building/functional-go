...
func PMap<FINPUT_TYPE><FOUTPUT_TYPE>Ptr(f func(*<INPUT_TYPE>) *<OUTPUT_TYPE>, list []*<INPUT_TYPE>) []*<OUTPUT_TYPE> {
	if f == nil {
		return []*<OUTPUT_TYPE>{}
	}
...
func PMapIOPtrErr() string {
	return `
// PMap<FINPUT_TYPE><FOUTPUT_TYPE>PtrErr applies the function(1st argument) on each item of the list and returns new list and error.
// Run in parallel. no_of_goroutines = no_of_items_in_list
//
// Takes 2 inputs
...
//	Empty list if all arguments are nil or either one is nil
func PMap<FINPUT_TYPE><FOUTPUT_TYPE>PtrErr(f func(*<INPUT_TYPE>) (*<OUTPUT_TYPE>, error), list []*<INPUT_TYPE>) ([]*<OUTPUT_TYPE>, error) {
	if f == nil {
