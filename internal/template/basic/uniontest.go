...
func TestUnion<FTYPE>(t *testing.T) {
	...
	if len(actual) != 3 || !Exists<FTYPE>(v8, actual) || !Exists<FTYPE>(v2, actual) || !Exists<FTYPE>(v0, actual) {
	...
	if len(actualPtr) != 3 || !Exists<FTYPE>Ptr(&v8, actualPtr) || !Exists<FTYPE>Ptr(&v2, actualPtr) || !Exists<FTYPE>Ptr(&v0, actualPtr) {
