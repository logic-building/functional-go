...
func FilterMap<FINPUT_TYPE><FOUTPUT_TYPE>Ptr(fFilter func(*<INPUT_TYPE>) bool, fMap func(*<INPUT_TYPE>) *<OUTPUT_TYPE>, list []*<INPUT_TYPE>) []*<OUTPUT_TYPE> {
...
// FilterMapIOPtrErr filters list based on function passed as 1st argument
func FilterMapIOPtrErr() string {
	return `
// FilterMap<FINPUT_TYPE><FOUTPUT_TYPE>PtrErr filters given list, then apply function(2nd argument) on each item in the list and returns a new list, error
// Takes 3 inputs
...
//  Empty list if all there parameters are nil or either of parameter is nil
func FilterMap<FINPUT_TYPE><FOUTPUT_TYPE>PtrErr(fFilter func(*<INPUT_TYPE>) (bool, error), fMap func(*<INPUT_TYPE>) (*<OUTPUT_TYPE>, error), list []*<INPUT_TYPE>) ([]*<OUTPUT_TYPE>, error) {
	if fFilter == nil || fMap == nil {
