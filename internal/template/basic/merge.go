...
func Merge() string {
	return `
// Merge<FINPUT_TYPE1><FINPUT_TYPE2> takes two input: map[<INPUT_TYPE1>]<INPUT_TYPE2> and map[<INPUT_TYPE1>]<INPUT_TYPE2> and merge two maps and returns a new map[<INPUT_TYPE1>]<INPUT_TYPE2>.
