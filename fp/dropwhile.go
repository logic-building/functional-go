...
//	Drop the items from the list as long as condition satisfies.
//
//	Takes two inputs
...
//  Returns: New List
//
// 	Example: Drop even number. Returns the remaining items once odd number is found in the list.
...
//  Returns: New List
//
// 	Example: Drop positive numbers. Returns the remaining items once negative number is found in the list.
...
//  Returns: New List
//
// 	Example: Drop names as long as it's length is <10.
//		fp.DropWhileStr(
