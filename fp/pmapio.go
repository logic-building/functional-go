...
// PMapIntInt applies the function(1st argument) on each item of the list and returns new list.
// Run in parallel. no_of_goroutines = no_of_items_in_list
//
// Takes 2 inputs
//	1. Function - takes 1 input type: int output type: int
//	2. List
//
// Returns
//	New List of type int
//	Empty list if all arguments are nil or either one is nil
func PMapIntInt(f func(int) int, list []int) []int {
	if f == nil {
		return []int{}
	}
...
// PMapInt64Int64 applies the function(1st argument) on each item of the list and returns new list.
// Run in parallel. no_of_goroutines = no_of_items_in_list
//
// Takes 2 inputs
//	1. Function - takes 1 input type: int64 output type: int64
//	2. List
//
// Returns
//	New List of type int64
//	Empty list if all arguments are nil or either one is nil
func PMapInt64Int64(f func(int64) int64, list []int64) []int64 {
	if f == nil {
		return []int64{}
	}
...
// PMapInt32Int32 applies the function(1st argument) on each item of the list and returns new list.
// Run in parallel. no_of_goroutines = no_of_items_in_list
//
// Takes 2 inputs
//	1. Function - takes 1 input type: int32 output type: int32
//	2. List
//
// Returns
//	New List of type int32
//	Empty list if all arguments are nil or either one is nil
func PMapInt32Int32(f func(int32) int32, list []int32) []int32 {
	if f == nil {
		return []int32{}
	}
...
// PMapInt16Int16 applies the function(1st argument) on each item of the list and returns new list.
// Run in parallel. no_of_goroutines = no_of_items_in_list
//
// Takes 2 inputs
//	1. Function - takes 1 input type: int16 output type: int16
//	2. List
//
// Returns
//	New List of type int16
//	Empty list if all arguments are nil or either one is nil
func PMapInt16Int16(f func(int16) int16, list []int16) []int16 {
	if f == nil {
		return []int16{}
	}
...
// PMapInt8Int8 applies the function(1st argument) on each item of the list and returns new list.
// Run in parallel. no_of_goroutines = no_of_items_in_list
//
// Takes 2 inputs
//	1. Function - takes 1 input type: int8 output type: int8
//	2. List
//
// Returns
//	New List of type int8
//	Empty list if all arguments are nil or either one is nil
func PMapInt8Int8(f func(int8) int8, list []int8) []int8 {
	if f == nil {
		return []int8{}
	}
...
// PMapUintUint applies the function(1st argument) on each item of the list and returns new list.
// Run in parallel. no_of_goroutines = no_of_items_in_list
//
// Takes 2 inputs
//	1. Function - takes 1 input type: uint output type: uint
//	2. List
//
// Returns
//	New List of type uint
//	Empty list if all arguments are nil or either one is nil
func PMapUintUint(f func(uint) uint, list []uint) []uint {
	if f == nil {
		return []uint{}
	}
...
// PMapUint64Uint64 applies the function(1st argument) on each item of the list and returns new list.
// Run in parallel. no_of_goroutines = no_of_items_in_list
//
// Takes 2 inputs
//	1. Function - takes 1 input type: uint64 output type: uint64
//	2. List
//
// Returns
//	New List of type uint64
//	Empty list if all arguments are nil or either one is nil
func PMapUint64Uint64(f func(uint64) uint64, list []uint64) []uint64 {
	if f == nil {
		return []uint64{}
	}
...
// PMapUint32Uint32 applies the function(1st argument) on each item of the list and returns new list.
// Run in parallel. no_of_goroutines = no_of_items_in_list
//
// Takes 2 inputs
//	1. Function - takes 1 input type: uint32 output type: uint32
//	2. List
//
// Returns
//	New List of type uint32
//	Empty list if all arguments are nil or either one is nil
func PMapUint32Uint32(f func(uint32) uint32, list []uint32) []uint32 {
	if f == nil {
		return []uint32{}
	}
...
// PMapUint16Uint16 applies the function(1st argument) on each item of the list and returns new list.
// Run in parallel. no_of_goroutines = no_of_items_in_list
//
// Takes 2 inputs
//	1. Function - takes 1 input type: uint16 output type: uint16
//	2. List
//
// Returns
//	New List of type uint16
//	Empty list if all arguments are nil or either one is nil
func PMapUint16Uint16(f func(uint16) uint16, list []uint16) []uint16 {
	if f == nil {
		return []uint16{}
	}
...
// PMapUint8Uint8 applies the function(1st argument) on each item of the list and returns new list.
// Run in parallel. no_of_goroutines = no_of_items_in_list
//
// Takes 2 inputs
//	1. Function - takes 1 input type: uint8 output type: uint8
//	2. List
//
// Returns
//	New List of type uint8
//	Empty list if all arguments are nil or either one is nil
func PMapUint8Uint8(f func(uint8) uint8, list []uint8) []uint8 {
	if f == nil {
		return []uint8{}
	}
...
// PMapStrStr applies the function(1st argument) on each item of the list and returns new list.
// Run in parallel. no_of_goroutines = no_of_items_in_list
//
// Takes 2 inputs
//	1. Function - takes 1 input type: string output type: string
//	2. List
//
// Returns
//	New List of type string
//	Empty list if all arguments are nil or either one is nil
func PMapStrStr(f func(string) string, list []string) []string {
	if f == nil {
		return []string{}
	}
