...
func TestPmapIntPtrErr(t *testing.T) {
	...
	squareList, _ := PMapIntPtrErr(squareIntPtrErr, []*int{&v1, &v2, &v3})
	...
	sumList, _ := PMapIntPtrErr(partialAddIntPtrErr, []*int{&v1, &v2, &v3})
	...
	_, err := PMapIntPtrErr(squareIntPtrErr, []*int{&v1, &v0, &v0, &v0, &v3})
	if err == nil {
		t.Errorf("PMapIntPtrErr failed.expected=%v, actual=%v", expectedSquareList, sumList)
	}
}
...
func TestPmapInt64PtrErr(t *testing.T) {
	...
	squareList, _ := PMapInt64PtrErr(squareInt64PtrErr, []*int64{&v1, &v2, &v3})
	...
	sumList, _ := PMapInt64PtrErr(partialAddInt64PtrErr, []*int64{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
	...
	_, err := PMapInt64PtrErr(squareInt64PtrErr, []*int64{&v1, &v0, &v0, &v0, &v3})
	if err == nil {
		t.Errorf("PMapInt64PtrErr failed.expected=%v, actual=%v", expectedSquareList, sumList)
	}
}
...
func TestPmapInt32PtrErr(t *testing.T) {
	...
	squareList, _ := PMapInt32PtrErr(squareInt32PtrErr, []*int32{&v1, &v2, &v3})
	...
	sumList, _ := PMapInt32PtrErr(partialAddInt32PtrErr, []*int32{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
	...
	_, err := PMapInt32PtrErr(squareInt32PtrErr, []*int32{&v1, &v0, &v0, &v0, &v3})
	if err == nil {
		t.Errorf("PMapInt32PtrErr failed.expected=%v, actual=%v", expectedSquareList, sumList)
	}
}
...
func TestPmapInt16PtrErr(t *testing.T) {
	...
	squareList, _ := PMapInt16PtrErr(squareInt16PtrErr, []*int16{&v1, &v2, &v3})
	...
	sumList, _ := PMapInt16PtrErr(partialAddInt16PtrErr, []*int16{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
	...
	_, err := PMapInt16PtrErr(squareInt16PtrErr, []*int16{&v1, &v0, &v0, &v0, &v3})
	if err == nil {
		t.Errorf("PMapInt16PtrErr failed.expected=%v, actual=%v", expectedSquareList, sumList)
	}
}
...
func TestPmapInt8PtrErr(t *testing.T) {
	...
	squareList, _ := PMapInt8PtrErr(squareInt8PtrErr, []*int8{&v1, &v2, &v3})
	...
	sumList, _ := PMapInt8PtrErr(partialAddInt8PtrErr, []*int8{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
	...
	_, err := PMapInt8PtrErr(squareInt8PtrErr, []*int8{&v1, &v0, &v0, &v0, &v3})
	if err == nil {
		t.Errorf("PMapInt8PtrErr failed.expected=%v, actual=%v", expectedSquareList, sumList)
	}
}
...
func TestPmapUintPtrErr(t *testing.T) {
	...
	squareList, _ := PMapUintPtrErr(squareUintPtrErr, []*uint{&v1, &v2, &v3})
	...
	sumList, _ := PMapUintPtrErr(partialAddUintPtrErr, []*uint{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
	...
	_, err := PMapUintPtrErr(squareUintPtrErr, []*uint{&v1, &v0, &v0, &v0, &v3})
	if err == nil {
		t.Errorf("PMapUintPtrErr failed.expected=%v, actual=%v", expectedSquareList, sumList)
	}
}
...
func TestPmapUint64PtrErr(t *testing.T) {
	...
	squareList, _ := PMapUint64PtrErr(squareUint64PtrErr, []*uint64{&v1, &v2, &v3})
	...
	sumList, _ := PMapUint64PtrErr(partialAddUint64PtrErr, []*uint64{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
	...
	_, err := PMapUint64PtrErr(squareUint64PtrErr, []*uint64{&v1, &v0, &v0, &v0, &v3})
	if err == nil {
		t.Errorf("PMapUint64PtrErr failed.expected=%v, actual=%v", expectedSquareList, sumList)
	}
}
...
func TestPmapUint32PtrErr(t *testing.T) {
	...
	squareList, _ := PMapUint32PtrErr(squareUint32PtrErr, []*uint32{&v1, &v2, &v3})
	...
	sumList, _ := PMapUint32PtrErr(partialAddUint32PtrErr, []*uint32{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
	...
	_, err := PMapUint32PtrErr(squareUint32PtrErr, []*uint32{&v1, &v0, &v0, &v0, &v3})
	if err == nil {
		t.Errorf("PMapUint32PtrErr failed.expected=%v, actual=%v", expectedSquareList, sumList)
	}
}
...
func TestPmapUint16PtrErr(t *testing.T) {
	...
	squareList, _ := PMapUint16PtrErr(squareUint16PtrErr, []*uint16{&v1, &v2, &v3})
	...
	sumList, _ := PMapUint16PtrErr(partialAddUint16PtrErr, []*uint16{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
	...
	_, err := PMapUint16PtrErr(squareUint16PtrErr, []*uint16{&v1, &v0, &v0, &v0, &v3})
	if err == nil {
		t.Errorf("PMapUint16PtrErr failed.expected=%v, actual=%v", expectedSquareList, sumList)
	}
}
...
func TestPmapUint8PtrErr(t *testing.T) {
	...
	squareList, _ := PMapUint8PtrErr(squareUint8PtrErr, []*uint8{&v1, &v2, &v3})
	...
	sumList, _ := PMapUint8PtrErr(partialAddUint8PtrErr, []*uint8{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
	...
	_, err := PMapUint8PtrErr(squareUint8PtrErr, []*uint8{&v1, &v0, &v0, &v0, &v3})
	if err == nil {
		t.Errorf("PMapUint8PtrErr failed.expected=%v, actual=%v", expectedSquareList, sumList)
	}
}
...
func TestPMapBoolPtrErr(t *testing.T) {
	...
	newList, _ := PMapBoolPtrErr(inverseBoolPtrErr, []*bool{&vt})
	...
	_, err := PMapBoolPtrErr(inverseBoolPtrErr, []*bool{&vf, &vf, &vf, &vt})
	if err == nil {
		t.Errorf("MapBoolPtrErr failed")
	}
}
...
func TestPmapFloat32PtrErr(t *testing.T) {
	...
	squareList, _ := PMapFloat32PtrErr(squareFloat32PtrErr, []*float32{&v1, &v2, &v3})
	...
	sumList, _ := PMapFloat32PtrErr(partialAddFloat32PtrErr, []*float32{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
	...
	_, err := PMapFloat32PtrErr(squareFloat32PtrErr, []*float32{&v1, &v0, &v0, &v0, &v3})
	if err == nil {
		t.Errorf("PMapFloat32PtrErr failed.expected=%v, actual=%v", expectedSquareList, sumList)
	}
}
...
func TestPmapFloat64PtrErr(t *testing.T) {
	...
	squareList, _ := PMapFloat64PtrErr(squareFloat64PtrErr, []*float64{&v1, &v2, &v3})
	...
	sumList, _ := PMapFloat64PtrErr(partialAddFloat64PtrErr, []*float64{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
	...
	_, err := PMapFloat64PtrErr(squareFloat64PtrErr, []*float64{&v1, &v0, &v0, &v0, &v3})
	if err == nil {
		t.Errorf("PMapFloat64PtrErr failed.expected=%v, actual=%v", expectedSquareList, sumList)
	}
}
