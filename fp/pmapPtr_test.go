...
func TestPmapIntPtr(t *testing.T) {
	...
	squareList := PMapIntPtr(squareIntPtr, []*int{&v1, &v2, &v3})
	...
	sumList := PMapIntPtr(partialAddIntPtr, []*int{&v1, &v2, &v3})
...
func TestPmapInt64Ptr(t *testing.T) {
	...
	squareList := PMapInt64Ptr(squareInt64Ptr, []*int64{&v1, &v2, &v3})
	...
	sumList := PMapInt64Ptr(partialAddInt64Ptr, []*int64{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
...
func TestPmapInt32Ptr(t *testing.T) {
	...
	squareList := PMapInt32Ptr(squareInt32Ptr, []*int32{&v1, &v2, &v3})
	...
	sumList := PMapInt32Ptr(partialAddInt32Ptr, []*int32{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
...
func TestPmapInt16Ptr(t *testing.T) {
	...
	squareList := PMapInt16Ptr(squareInt16Ptr, []*int16{&v1, &v2, &v3})
	...
	sumList := PMapInt16Ptr(partialAddInt16Ptr, []*int16{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
...
func TestPmapInt8Ptr(t *testing.T) {
	...
	squareList := PMapInt8Ptr(squareInt8Ptr, []*int8{&v1, &v2, &v3})
	...
	sumList := PMapInt8Ptr(partialAddInt8Ptr, []*int8{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
...
func TestPmapUintPtr(t *testing.T) {
	...
	squareList := PMapUintPtr(squareUintPtr, []*uint{&v1, &v2, &v3})
	...
	sumList := PMapUintPtr(partialAddUintPtr, []*uint{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
...
func TestPmapUint64Ptr(t *testing.T) {
	...
	squareList := PMapUint64Ptr(squareUint64Ptr, []*uint64{&v1, &v2, &v3})
	...
	sumList := PMapUint64Ptr(partialAddUint64Ptr, []*uint64{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
...
func TestPmapUint32Ptr(t *testing.T) {
	...
	squareList := PMapUint32Ptr(squareUint32Ptr, []*uint32{&v1, &v2, &v3})
	...
	sumList := PMapUint32Ptr(partialAddUint32Ptr, []*uint32{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
...
func TestPmapUint16Ptr(t *testing.T) {
	...
	squareList := PMapUint16Ptr(squareUint16Ptr, []*uint16{&v1, &v2, &v3})
	...
	sumList := PMapUint16Ptr(partialAddUint16Ptr, []*uint16{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
...
func TestPmapUint8Ptr(t *testing.T) {
	...
	squareList := PMapUint8Ptr(squareUint8Ptr, []*uint8{&v1, &v2, &v3})
	...
	sumList := PMapUint8Ptr(partialAddUint8Ptr, []*uint8{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
...
func TestPmapFloat32Ptr(t *testing.T) {
	...
	squareList := PMapFloat32Ptr(squareFloat32Ptr, []*float32{&v1, &v2, &v3})
	...
	sumList := PMapFloat32Ptr(partialAddFloat32Ptr, []*float32{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
...
func TestPmapFloat64Ptr(t *testing.T) {
	...
	squareList := PMapFloat64Ptr(squareFloat64Ptr, []*float64{&v1, &v2, &v3})
	...
	sumList := PMapFloat64Ptr(partialAddFloat64Ptr, []*float64{&v1, &v2, &v3})
	if *sumList[0] != *expectedSumList[0] || *sumList[1] != *expectedSumList[1] || *sumList[2] != *expectedSumList[2] {
